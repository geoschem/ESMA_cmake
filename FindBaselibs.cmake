...
#
## Use if BASEDIR AND NOT EXISTS ${BASEDIR} if using GCHP, rather than just if
## NOT EXISTS. If BASEDIR evaluates to TRUE but it isn't a valid path throw an
## error. This lets BASEDIR be skipped if BASEDIR is set to a false value
## (e.g. setting BASEDIR to IGNORE)
#if (BASEDIR AND NOT EXISTS ${BASEDIR})
#  message (FATAL_ERROR "ERROR: Must specify a value for BASEDIR with cmake ... -DBASEDIR=<path>.")
#
#==GMAO has this instead. I suspect it was put in for us. Try it...=====
...
# ewl: I think we can keep the GCHP stuff and remove the commented
# out old gmao stuff, then comment out new gmao stuff, with the exception of
# wrapping in if baselibs found.
...
# this part here, I think we can replace with below... (ewl)
...
# this part we have above, commented out
...
#>>>>>>> gmao/v3.3.7
  ...
  # ewl: gchp has this outside if basedir....keep here?
